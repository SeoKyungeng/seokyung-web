...
- [x] CEO 인사말
  - [x] 풀너비 텍스트 레이아웃 (사진 미사용 확정)
  - [x] highlight 문장 H2 중앙 정렬
  - [x] accent line (primary-400, w-16, 2px)
  - [x] body 다단락 텍스트 (max-w-3xl)
  - [x] 이름/직함 우측 정렬 + border-top
- [x] 경영이념
  - [x] smoke 배경 섹션
  - [x] 슬로건 텍스트 (중앙 정렬)
  - [x] 3컬럼 카드 그리드 (고객/품질/사람)
  - [x] 카드: 아이콘 + 제목 + 부제 + 항목 리스트
  - [x] hover shadow + border-primary 전환
- [x] 조직도
  - [x] 다크 섹션 (slate 배경)
  - [x] 2단계 트리 (CEO → 부서 5 → 팀 12)
...
- [x] 모바일 대응
  - [x] CEO 인사말 1컬럼 (highlight 축소)
  - [x] 경영이념 카드 1컬럼 스택
  - [x] 조직도 세로 리스트 + 들여쓰기 계층
  - [x] 고객사 2열 유지
...
- [x] 콘텐츠 반영
  ...
  - [x] 15개 장비 데이터 반영 (v1.1: SL 분리, 명칭 교정, 스펙 보충)
  - [x] eq-15 VM960 — 현 정보 유지 확정 (수량 1대)
  - [x] 장비 사진 교체
