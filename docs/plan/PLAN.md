...
| ✅ | 설비 데이터 (15개 모델, 총 19대) | 사진 수신 및 적용 완료 |
| ✅ | 제품 사진 (방산/열교환기/기타) | 수신 및 적용 완료 |
| ✅ | ESG 콘텐츠 | ESG 텍스트 수신, 이미지 추후 제공, 인증 현황 제거 확정 (2026-03-22) |
| ✅ | 회사 연락처 (주소/전화/팩스/이메일) | 수신 및 적용 완료 |
...
| 2 | 회사 연혁 섹션 포함 여부 | 미포함 확정 | 클라이언트 | ✅ 완료 |
| 3 | 문의 폼 파일 첨부 기능 | 미포함 확정 | 클라이언트 | ✅ 완료 |
| 4 | 디자인 컨셉 최종 확정 | 현재 디자인으로 확정 | 클라이언트 | ✅ 완료 |
| 5 | 지도 서비스 선택 | 지도 연결 안 함 | 개발자 | ✅ 완료 |
| 6 | 이메일 발송 서비스 | Nodemailer + SMTP (구현 완료) | 개발자 | ✅ 완료 |
| 7 | eq-08/09: 명칭 교정 | 고속정밀선반 ↔ 강력중절삭 대형선반 교차 수정 | 클라이언트 | ✅ 완료 |
| 8 | eq-11: 래디얼 드릴 교체 사진 | 사진 수령 완료 (2026-03-22) | 클라이언트 | ✅ 완료 |
| 9 | eq-12: 5축 머시닝센터 | 수량 1대 확정, 가공사례 스펙 반영 | 클라이언트 | ✅ 완료 |
| 10 | eq-13/14: SL 시리즈 분리 | SL 2500(2대) + SL 3000(2대) 분리 완료 | 클라이언트 | ✅ 완료 |
| 11 | eq-15: VM960 | 모델명만 존재, 현 정보 유지 (수량 1대) | 클라이언트 | ✅ 완료 |
