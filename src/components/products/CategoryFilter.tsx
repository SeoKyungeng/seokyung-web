        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={[
                "relative flex-shrink-0 scroll-snap-align-start px-5 py-4 text-sm font-medium transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2",
                isActive
            ...
            >
              ...
              {isActive && (
                <motion.span
                  ...
                  className="absolute bottom-2 left-1/2 h-1 w-1 -translate-x-1/2 rounded-full bg-cyan-400"
                  transition={
                    reducedMotion
                      ? { duration: 0 }
